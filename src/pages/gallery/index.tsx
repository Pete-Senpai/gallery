    ...
    return (
        <Container>
            <Grid container spacing={3}>
                {photos.map(photo => (
                    <Grid item key={photo} xs={12} md={6} lg={4}>
                        <Card>
                            <CardMedia 
                                component="img"
                                height="100%"
